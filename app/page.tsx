    ...
    <main className="min-h-screen bg-[#020617] text-white flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="relative inline-flex flex-col items-center">
          ...
          <Link
            href="/dashboard"
            className="group relative inline-flex items-center gap-4 overflow-hidden rounded-[2rem] border border-cyan-300/40 bg-gradient-to-r from-cyan-400/90 via-blue-500/90 to-indigo-600/90 px-12 py-5 text-2xl font-black text-white shadow-[0_0_50px_rgba(34,211,238,0.55)] transition duration-300 hover:scale-105 hover:shadow-[0_0_80px_rgba(59,130,246,0.9)]"
          >
